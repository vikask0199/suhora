...
export const HowItsWorks = ({currentTheme}:howWorks) => {
    ...
    return (
        <Box py={{ base: '4', md: '8', lg: '12' }} backgroundColor={backgroundColor}>
            <Container maxW="6xl">
                ...
                <Text color={theme.companyTheme.color.third} fontSize={theme.fonts.subHeading.size} fontWeight={theme.fonts.subHeading.weight} maxW="6xl" pb={{ base: '4', md: '8' }} textAlign="center">
